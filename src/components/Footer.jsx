          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
            ...
            <div className="flex flex-col items-start">
              ...
              <div className="flex items-center space-x-3">
                {/* Each icon links to respective social media (currently placeholder /) */}
                <Link to="#" className="bg-amber-800 p-2 rounded-full hover:bg-amber-600 transition-colors shadow-md" aria-label="Facebook">
                  <Facebook className="w-4 h-4 text-white" />
                </Link>
                <Link to="#" className="bg-amber-800 p-2 rounded-full hover:bg-amber-600 transition-colors shadow-md" aria-label="Twitter">
                  <Twitter className="w-4 h-4 text-white" />
                </Link>
                <Link to="#" className="bg-amber-800 p-2 rounded-full hover:bg-amber-600 transition-colors shadow-md" aria-label="Instagram">
                  <Instagram className="w-4 h-4 text-white" />
                </Link>
                <Link to="#" className="bg-amber-800 p-2 rounded-full hover:bg-amber-600 transition-colors shadow-md" aria-label="LinkedIn">
            ...
            <div className="flex flex-col">
              ...
              <ul className="space-y-2 sm:space-y-3">
                {/* Home Link */}
                <li>
                  <Link to="/" className="text-gray-700 hover:text-amber-600 transition-colors text-sm sm:text-base flex items-center group">
                ...
                {/* Browse Books Link */}
                <li>
                  <Link to="/browse-books" className="text-gray-700 hover:text-amber-600 transition-colors text-sm sm:text-base flex items-center group">
                    <span className="w-2 h-2 bg-amber-800 rounded-full mr-2 group-hover:scale-125 transition-transform"></span>
                    Browse Books
                  </Link>
                </li>
                ...
                {/* Add Book Link */}
                <li>
                  <Link to="/add-book" className="text-gray-700 hover:text-amber-600 transition-colors text-sm sm:text-base flex items-center group">
                    <span className="w-2 h-2 bg-amber-800 rounded-full mr-2 group-hover:scale-125 transition-transform"></span>
                    Add Book
                  </Link>
                </li>
            ...
            <div className="flex flex-col">
              ...
              <ul className="space-y-2 sm:space-y-3">
                {categories
                  .filter(cat => cat.category.toLowerCase() !== 'all') // exclude 'All' category
                  .map((cat) => (
                    <li key={cat.id}>
                      <Link to={`/books/${cat.category}`}
                        ...
                        onClick={() => {
                          onCategorySelect(cat.category); // Trigger parent category selection
                        }}
                      >
                        <span className="w-2 h-2 bg-amber-800 rounded-full mr-2 group-hover:scale-125 transition-transform"></span>
                        {cat.category}
              ...
              <ul className="space-y-3 sm:space-y-4">
                ...
                <li className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <Link to="#" className="text-gray-600 hover:text-amber-600 transition-colors text-xs sm:text-sm">
                      info@Library.com
                    </Link>
                  </div>
                </li>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col sm:flex-row justify-center items-center space-y-3 sm:space-y-0">
              ...
              {/* <div className="flex flex-wrap justify-center items-center gap-3 sm:gap-6">
                <Link to="#" className="text-white hover:text-amber-100 transition-colors text-xs sm:text-sm font-medium">
                  Privacy Policy
                </Link>
